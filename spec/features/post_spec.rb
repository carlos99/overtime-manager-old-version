...
describe 'navigate' do
  ...
  let(:post) do
    Post.create(date: Date.today, work_performed: "Work Performed", user_id: user.id, daily_hours: 14.5)
  end
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      ...
      post_from_other_user = Post.create(date: Date.today, work_performed: "This post shouldn't be seen", user_id: other_user.id, daily_hours: 14.5)
  ...
  describe 'delete' do
    it 'can be deleted' do
      ...
      post_to_delete = Post.create(date: Date.today, work_performed: 'asdf', user_id: delete_user.id, daily_hours: 14.5)
  ...
  describe 'creation' do
      ...
      fill_in 'post[work_performed]', with: "Some word performed"
