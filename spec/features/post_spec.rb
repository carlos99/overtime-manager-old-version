...
describe 'navigate' do
  ...
  let(:post) do
    Post.create(date: Date.today, rationale: "Rationale", user_id: user.id, daily_hours: 14.5)
  end
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      ...
      post_from_other_user = Post.create(date: Date.today, rationale: "This post shouldn't be seen", user_id: other_user.id, daily_hours: 14.5)
  ...
  describe 'delete' do
    it 'can be deleted' do
      ...
      post_to_delete = Post.create(date: Date.today, rationale: 'asdf', user_id: delete_user.id, daily_hours: 14.5)
